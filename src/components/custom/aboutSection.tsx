...
export default function AboutSection() {
  return (
    <section className="flex flex-col justify-between bg-secondary">
      <div className="grid grid-cols-2 min-h-screen text-card place-self-center gap-5 px-2 py-6">
        ...
        <div className="flex flex-col justify-center gap-8">
          ...
          <p className="w-[75%]">
            ...
            Numquam vitae earum aspernatur sint placeat porro perferendis
            nesciunt vero magni repellat!
          </p>
