            ...
            <div className="grid col-span-1 bg-accent p-3 w-[110%] place-content-start gap-5 py-5">
              <div className="flex items-center gap-3">
                <div className="flex flex-col gap-1 bg-(--rating-3-solid) p-2 px-3 text-center">
                  <p className="font-pixel text-2xl">3+</p>
                  <p>IGRS</p>
                </div>
                <div className="flex flex-col gap-1">
                  <p className="text-(--rating-3-solid) font-pixel text-lg tracking-wider">
                    Rating IGRS
                  </p>
                ...
                idx < 6 ? (
                  ...
                  >
                    <div className="relative">
                      ...
                      />
                      <div
                        className={`absolute flex flex-col bg-(--rating-${i.rating}-solid) bottom-0 m-3 p-1 text-center`}
                      >
                        <p className="font-pixel text-2xl">{i.rating}+</p>
                        <p className="px-1 text-xs">IGRS</p>
                      </div>
                    </div>
