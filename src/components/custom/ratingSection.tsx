    ...
    <section className="min-h-screen text-card flex flex-col gap-5 p-6">
      ...
      <div className="flex flex-col gap-4 mt-8">
        <div className="flex items-center gap-2">
          <LayoutTemplate className="text-(--accent-yellow) fill-(--accent-yellow) size-5" />
        ...
        <div className="flex flex-wrap items-center gap-3">
          <Badge
            ...
            className={`p-4 px-5 border cursor-pointer transition select-none flex items-center gap-1.5 font-semibold text-xs md:text-sm ${
              activeRating === 3
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 my-6">
          ...
          <div className="lg:col-span-1 bg-slate-900/40 border border-slate-800/80 p-5 rounded-xl flex flex-col justify-between gap-5 relative overflow-hidden backdrop-blur-xs">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-xs md:text-sm text-slate-350 leading-relaxed font-normal mt-2">
                {activeMeta.desc}
              </p>
            </div>
            <Link
          ...
          <div className="lg:col-span-3">
            {displayedGames.length > 0 ? (
              ...
              <div className="text-center py-12 bg-slate-900/20 border border-slate-800/80 rounded-xl backdrop-blur-xs flex flex-col items-center justify-center gap-2">
                <p className="text-xs md:text-sm text-slate-400">
                  Tidak ada gim terdaftar untuk rating {activeRating}+ saat ini.
                </p>
              </div>
            )}
          </div>
