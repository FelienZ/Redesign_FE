...
import { newsConfig } from "@/styleConfig";
import {
  CalendarDays,
  ChevronRight,
  Clock,
...
export default function NewsSection() {
  return (
    <section className="min-h-screen bg-secondary flex flex-col gap-6 px-4 py-8">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-x-2">
          <GripVertical className="size-8 text-primary" />
          <div className="flex flex-col font-bold">
            <h3 className="text-primary font-[Pixelify_Sans]">Info Terkini</h3>
